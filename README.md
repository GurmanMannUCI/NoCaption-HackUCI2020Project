# No-Cap-tion---HackUCI-2020-project
 A caption generator based on image attributes. Parses uploaded images and recommends some song lyrics. Built at HackUCI.
 # No Cap(tion)
 Give us an image, and we'll give you a lyric based caption. No cap.
 Built at Hack UCI 2020 by Chris(@RodriguezDev), Alex & Gurman(Me).
